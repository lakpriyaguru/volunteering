                          ...
                          while ($result = mysqli_fetch_array($query)) {
                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $result['noAdults'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $result['noChildrens'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $result['bookingDate'] ?>/
                                                        <?php echo $result['bookingTime'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $result['postingDate'] ?>
                                                    </td>
                                                    <th>
                                                        <a href="booking-details.php?bid=<?php echo $result['id']; ?>"
