...
if (strlen($_SESSION['adminID']) == 0) {
    ...
    if ($_GET['action'] == 'delete') {
        ...
        if ($query) {
            echo "<script>alert('Organization record deleted successfully.');</script>";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <a href="orgEdit.php?said=<?php echo $result['orgID']; ?>"
                                                                    title="Edit Organization Details"> <i class="fa fa-edit"
                                                                        aria-hidden="true"></i> </a>
                                                                <a href="orgManage.php?action=delete&&said=<?php echo $result['orgID']; ?>"
