...
if (strlen($_SESSION['adminID']) == 0) {
  ...
  if (isset($_POST['update'])) {
    ...
    if ($query) {
      echo "<script>alert('Event details edited successfully.');</script>";
                  ...
                  <div class="card card-primary">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="parentName" name="parentName"
                        placeholder="Enter User Full Name" value="<?php echo $result['orgName']; ?>" readonly>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="eventName" name="eventName"
                        placeholder="Enter Event Name" value="<?php echo $result['eventName']; ?>" required>
                    </div>

                    <div class="form-group">
                      <label for="tet">Event Description</label>
                      <input type="text" class="form-control" id="eventDesc" name="eventDesc"
                        placeholder="Enter Event Description" value="<?php echo $result['eventDesc']; ?>" required>
                    </div>
                    <!-- Sub admin Email---->
                        <div class="form-group">
                          <label for="eventStart">Start Date & Time</label>
                          <input type="datetime-local" class="form-control" id="eventStart" name="eventStart"
                            placeholder="Enter Event Start Date & Time" value="<?php echo $result['eventStart']; ?>"
                            required>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="datetime-local" class="form-control" id="eventEnd" name="eventEnd"
                            placeholder="Enter Event End Date & Time" value="<?php echo $result['eventEnd']; ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="eventNeed" name="eventNeed"
                            placeholder="Enter Required # of Volunteers" value="<?php echo $result['eventNeed']; ?>"
                            required>
                        </div>
