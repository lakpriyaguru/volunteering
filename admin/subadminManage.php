...
if (strlen($_SESSION['adminID']) == 0) {
    ...
    if ($_GET['action'] == 'delete') {
        ...
        $query = mysqli_query($con, "delete from admin where adminID = '$adminID'");
        if ($query) {
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php $query = mysqli_query($con, "select * from admin where adminType = '0' ");
                                                    $cnt = 1;
                                                    while ($result = mysqli_fetch_array($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $result['adminEmail'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $result['adminContact'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $result['adminRegDate'] ?>
                                                            </td>
                                                            <th>
                                                                <a href="subadminEdit.php?said=<?php echo $result['adminID']; ?>"
                                                                    title="Edit Sub Admin Details"> <i class="fa fa-edit"
                                                                        aria-hidden="true"></i> </a>
                                                                <a href="subadminManage.php?action=delete&&said=<?php echo $result['adminID']; ?>"
                                                                    style="color:red;" title="Delete this record"
                                                                    onclick="return confirm('Do you really want to delete this record?');"><i
                                                                        class="fa fa-trash" aria-hidden="true"></i> </a>
                                                                <a href="subadminResetPwd.php?said=<?php echo $result['adminID']; ?>"
