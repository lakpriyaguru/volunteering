...
if (isset($_POST['resetpwd'])) {
  ...
  $sql = mysqli_query($con, "SELECT adminID FROM admin WHERE adminEmail='$email' and adminContact='$mobileNumber'");
  $rowcount = mysqli_num_rows($sql);

  if ($rowcount > 0) {
    $query = mysqli_query($con, "update admin set adminPassword='$newpassword' where adminEmail='$email' and adminContact='$mobileNumber'");
    if ($query) {
